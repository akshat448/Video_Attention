...
class CLIPDataset(Dataset):
    ...
    def __init__(self, data_dir, tokenizer, max_length=77):
        """
        Args:
            data_dir: Directory containing *_cluster_clip_data.npz files
        ...
        self.clip_files = list(self.data_dir.glob("*_cluster_clip_data.npz"))
        
        logger.info(f"Found {len(self.clip_files)} cluster clip data files in {data_dir}")
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            return {
                ...
                "caption": caption,
                "video_id": clip_file.stem.split("_cluster_clip_data")[0]
            }
...
def main():
    parser = argparse.ArgumentParser(description="Train CLIP model on cluster caption pairs")
    
    # Data arguments
    parser.add_argument("--data_dir", type=str, default="cluster_clip_data",
                        help="Directory containing *_cluster_clip_data.npz files")
    parser.add_argument("--output_dir", type=str, default="cluster_clip_model",
                        help="Directory to save model checkpoints")
    
    # Model arguments
    parser.add_argument("--embedding_dim", type=int, default=768,
                        help="Dimension of the cluster embeddings")
    ...
    parser.add_argument("--epochs", type=int, default=20,
                        help="Number of training epochs - match train_clip.py")
    ...
    if len(dataset) == 0:
        logger.error("No training data found. Please run cluster_mapping.py first.")
        return
